...
function getSelectedCharacter() {
  ...
  for (const characterKey in characterList) {
    ...
    if (item == "true") {
      ...
      if (cnt == 0) {
        document
          .getElementById("player1-full")
          .setAttribute("src", "./img/" + character.fileName);
        document
          .getElementById("x-img")
          .setAttribute("src", "./img/" + character.fileHeadName);

        cnt++;
      } else {
        document
          .getElementById("player2-full")
          .setAttribute("src", "./img/" + character.fileName);
        document
          .getElementById("o-img")
          .setAttribute("src", "./img/" + character.fileHeadName);
      }
    }
  }
